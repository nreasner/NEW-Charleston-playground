...
export function generateMetadata({params}) { const pg=getPlaygroundBySlug(params.slug); if(!pg)return{}; return{title:`${pg.name} — Charleston Playgrounds`,description:pg.desc}; }
